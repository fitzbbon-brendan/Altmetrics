...
test_that ("Messages, warnings, and errors show up", {
  expect_error(search_coord(long = -102.4660, lat = 51.83500),
               "One or more coordinates greater than 1000m")
  expect_warning(search_coord(long = -101.579544, lat = 51.818954),
  ...
  expect_error(search_coord(long = -102.4660, lat = "test"),
               "Longitude and latitude must be numbers.")
  expect_error(search_coord(long = -102.4660, lat = c(51.83500, 51.81913)),
