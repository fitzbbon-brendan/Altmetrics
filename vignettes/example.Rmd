...
For an explanation of quarter sections and other land types, please visit the [Get started](http://alexkoiter.ca/mbquartR/articles/mbquartR.html) page.
...
Your first step is to download the Manitoba Original Survey Legal Descriptions data from [DataMB](https://geoportal.gov.mb.ca/) which `mbquartR` helps you do.
