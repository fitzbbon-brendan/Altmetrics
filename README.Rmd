...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Location of the province of Manitoba and surrounding provinces and territories of Ontario (ON), Saskatchewan (SK), Nunavut (NU), and Northwest Territories (NT) within south-central Canada. Manitoban cities with a population > 10,000. Inset: Location of Manitoba within North America"}
