...
## Data Sources
The full list of quarter sections and coordinates are downloaded from [DataMB](https://geoportal.gov.mb.ca/). Note that occasionally this site is unavailable, in this situation an [archived version](https://github.com/alex-koiter/mbquartR/releases/) of the data is downloaded from the package repository on GitHub.
...
```{r echo = FALSE, fig.cap = "Location of the province of Manitoba and surrounding provinces and territories of Ontario (ON), Saskatchewan (SK), Nunavut (NU), and Northwest Territories (NT) within south-central Canada. Manitoban cities with a population > 10,000. Inset: Location of Manitoba within North America"}
